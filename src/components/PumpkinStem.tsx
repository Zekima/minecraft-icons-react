...
interface PumpkinStemProps extends React.SVGProps<SVGSVGElement> {
  /**
...
const PumpkinStem: React.ForwardRefRenderFunction<SVGSVGElement, PumpkinStemProps> = (
  { title, ...props },
  ref
) => {
  return (
...
const ForwardRefComponent = React.forwardRef(PumpkinStem);

// Add display name for better debugging in React DevTools
ForwardRefComponent.displayName = 'PumpkinStem';
