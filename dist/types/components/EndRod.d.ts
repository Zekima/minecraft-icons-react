...
declare const ForwardRefComponent: React.ForwardRefExoticComponent<Omit<EndRodProps, "ref"> & React.RefAttributes<SVGSVGElement>>;
export default ForwardRefComponent;
//# sourceMappingURL=EndRod.d.ts.map