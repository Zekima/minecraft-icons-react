...
declare const ForwardRefComponent: React.ForwardRefExoticComponent<Omit<WheatSeedsProps, "ref"> & React.RefAttributes<SVGSVGElement>>;
export default ForwardRefComponent;
//# sourceMappingURL=WheatSeeds.d.ts.map