...
declare const ForwardRefComponent: React.ForwardRefExoticComponent<Omit<StoneButtonProps, "ref"> & React.RefAttributes<SVGSVGElement>>;
export default ForwardRefComponent;
//# sourceMappingURL=StoneButton.d.ts.map