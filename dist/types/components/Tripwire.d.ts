...
declare const ForwardRefComponent: React.ForwardRefExoticComponent<Omit<TripwireProps, "ref"> & React.RefAttributes<SVGSVGElement>>;
export default ForwardRefComponent;
//# sourceMappingURL=Tripwire.d.ts.map