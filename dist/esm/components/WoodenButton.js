...
const WoodenButton = (_a, ref) => {
    var { title } = _a, props = __rest(_a, ["title"]);
    return (React.createElement("svg", Object.assign({ ref: ref, version: "1.1", xmlns: "http://www.w3.org/2000/svg", width: "32", height: "32", viewBox: "0 0 32 32", "shape-rendering": "crispEdges" // Inject the original attributes (width, height, viewBox, etc.)
     }, props),
...
//# sourceMappingURL=WoodenButton.js.map